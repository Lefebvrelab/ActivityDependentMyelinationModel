...
#define t_perturbation_on T/2//T/2//T/2+1
...
for (int q1=0;q1<Q;q1++)
{
		...
		{
	 			INSULT[q2]=0.0+1.0*q2/((double)Q-1);
	 			EPSILON[q1]=0.0+0.4*q1/((double)Q-1);//0.08;//40;//100;//60;//50;//50;//0+100*q/((double)Q);;//;30
	 			
				G[q1]=1.0;//0.0+3.0*q1/((double)Q-1);
	 			OMEGA[q2]=0.65;//0.1+2.9*q2/((double)Q-1);;//omega_o;
       //initial conditions   
...
//cout<<"Up to here 1..."<<endl;						
		...
		*/							
				...
				cout<<EPSILON[q1]<<"	"<<INSULT[q2]<<"	"<<MEAN_R[q1][q2]<<endl;
        	...
        	outfile.open("Kuramoto  - OP vs  INSULT vs EPSILON.txt", ios::out);
				...
				for (int q1=0;q1<Q;q1++)
				{
					for (int q2=0;q2<Q;q2++)
					{
			         					...
			         					outfile<<EPSILON[q1]<<"	"<<INSULT[q2]<<"	"<<MEAN_R[q1][q2]<<endl;
